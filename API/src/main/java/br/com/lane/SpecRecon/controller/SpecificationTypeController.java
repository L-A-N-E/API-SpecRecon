...
public class SpecificationTypeController {
    ...
    @ApiResponse(responseCode = "200", description = "Lista de tipos de especificação retornada com sucesso", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = SpecificationTypesResponseDTO.class)), examples = @ExampleObject(value = "[{\"id\": 1, \"name\": \"ENGINE\"}, {\"id\": 2, \"name\": \"COLOR\"}]")))
    @GetMapping
    ...
    @ApiResponse(responseCode = "200", description = "Tipo de especificação encontrado com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SpecificationTypesResponseDTO.class), examples = @ExampleObject(value = "{\"id\": 1, \"name\": \"ENGINE\"}")))
    @ApiResponse(responseCode = "404", description = "Tipo de especificação não encontrado", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 404, \"message\": \"Tipo de especificação não encontrado\"}")))
    @GetMapping("/{id}")
    ...
    @ApiResponse(responseCode = "201", description = "Tipo de especificação criado com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SpecificationTypesResponseDTO.class), examples = @ExampleObject(value = "{\"id\": 3, \"name\": \"TRANSMISSION\"}")))
    @ApiResponse(responseCode = "400", description = "Requisição inválida", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 400, \"message\": \"Nome do tipo de especificação inválido\"}")))
    @XSignatureHeader
    @PostMapping
    @Transactional
    public ResponseEntity<SpecificationTypesResponseDTO> create(
            @RequestBody(description = "Dados do tipo de especificação a ser criado", required = true, content = @Content(mediaType = "application/json", schema = @Schema(implementation = SpecificationTypesRequestDTO.class), examples = @ExampleObject(value = "{\"name\": \"TRANSMISSION\"}")))
    ...
    @ApiResponse(responseCode = "200", description = "Tipo de especificação atualizado com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SpecificationTypesResponseDTO.class), examples = @ExampleObject(value = "{\"id\": 1, \"name\": \"ENGINE_TYPE\"}")))
    @ApiResponse(responseCode = "404", description = "Tipo de especificação não encontrado", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 404, \"message\": \"Tipo de especificação não encontrado\"}")))
    @ApiResponse(responseCode = "400", description = "Requisição inválida", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 400, \"message\": \"Nome do tipo de especificação inválido\"}")))
    @XSignatureHeader
    @PutMapping("/{id}")
    ...
    public SpecificationTypesResponseDTO update(@PathVariable Long id,
                                   @RequestBody(description = "Novos dados do tipo de especificação", required = true, content = @Content(mediaType = "application/json", schema = @Schema(implementation = SpecificationTypesRequestDTO.class), examples = @ExampleObject(value = "{\"name\": \"ENGINE_TYPE\"}")))
                                   @Valid @org.springframework.web.bind.annotation.RequestBody SpecificationTypesRequestDTO spec, HttpServletRequest request) {
        SpecificationTypeModel model = spec.toModel();
