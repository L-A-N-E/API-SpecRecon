...
public class UserController {
    ...
    @ApiResponse(responseCode = "200", description = "Lista de usuários retornada com sucesso", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = UsersResponseDTO.class)), examples = @ExampleObject(value = "[{\"id\": 1, \"email\": \"admin@example.com\", \"role\": \"ADMIN\"}, {\"id\": 2, \"email\": \"user@example.com\", \"role\": \"USER\"}]")))
    @ApiResponse(responseCode = "403", description = "Acesso negado", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 403, \"message\": \"Acesso negado: Você não tem permissão para acessar este recurso.\"}")))
    @GetMapping
    ...
    @ApiResponse(responseCode = "200", description = "Usuário encontrado com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsersResponseDTO.class), examples = @ExampleObject(value = "{\"id\": 1, \"email\": \"admin@example.com\", \"role\": \"ADMIN\"}")))
    @ApiResponse(responseCode = "404", description = "Usuário não encontrado", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 404, \"message\": \"Usuário não encontrado\"}")))
    @ApiResponse(responseCode = "403", description = "Acesso negado", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 403, \"message\": \"Acesso negado: Você não tem permissão para acessar este recurso.\"}")))
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'ANALYST')")
    ...
    @ApiResponse(responseCode = "201", description = "Usuário criado com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsersResponseDTO.class), examples = @ExampleObject(value = "{\"id\": 3, \"email\": \"newuser@example.com\", \"role\": \"USER\"}")))
    @ApiResponse(responseCode = "400", description = "Requisição inválida", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 400, \"message\": \"Dados do usuário inválidos\"}")))
    @ApiResponse(responseCode = "403", description = "Acesso negado", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 403, \"message\": \"Acesso negado: Você não tem permissão para acessar este recurso.\"}")))
    @XSignatureHeader
    @PostMapping
    @Transactional
    ...
    @ApiResponse(responseCode = "200", description = "Usuário atualizado com sucesso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsersResponseDTO.class), examples = @ExampleObject(value = "{\"id\": 1, \"email\": \"admin_updated@example.com\", \"role\": \"ADMIN\"}")))
    @ApiResponse(responseCode = "404", description = "Usuário não encontrado", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 404, \"message\": \"Usuário não encontrado\"}")))
    @ApiResponse(responseCode = "400", description = "Requisição inválida", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 400, \"message\": \"Dados do usuário inválidos\"}")))
    @ApiResponse(responseCode = "403", description = "Acesso negado", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{\"status\": 403, \"message\": \"Acesso negado: Você não tem permissão para acessar este recurso.\"}")))
    @XSignatureHeader
