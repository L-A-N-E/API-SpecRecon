...
- [📝 7. Como Executar](#-7-como-executar-http)
- [🐋 8. Como Executar (Docker - Https)](#-8-como-executar-docker---https)
- [🎥 9. Vídeo API](#-9-vídeo-api)
- [⚒️ 10. Links Úteis](#️-10-links-úteis)
...
Para verificar a documentação, acesse a [documentação Swagger da API](http://localhost:8443/swagger-ui/index.html).
...
Fizemos um vídeo tutorial de como rodar a API com a segurança aplicada, para isso, clique neste [link](https://www.youtube.com/watch?v=pPPahV5tn5Y)
